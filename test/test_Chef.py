...
class TestSlice(unittest.TestCase):
    ...
    def test_heat_release_recipe(self):
        ...
        with open(os.path.join("test", "chef_test_hrr", "Header")) as hfile:
            hfile.readline()
            hfile.readline()
    ...
    def test_enthalpy_recipe(self):
        ...
        with open(os.path.join("test", "chef_test_ent", "Header")) as hfile:
            hfile.readline()
            hfile.readline()
    ...
    def test_reaction_rate_recipe(self):
        ...
        plot_chef.cook()
        # TODO: validate data with existing plotfile
        with open(os.path.join("test", "chef_test_Ri", "Header")) as hfile:
            hfile.readline()
            hfile.readline()
            self.assertTrue("IRm(O2)" in hfile.readline())
            self.assertTrue("IRm(H2)" in hfile.readline())
    ...
    def test_diffusion_coefficients_recipe(self):
        ...
        plot_chef.cook()
        # TODO: validate data with existing plotfile
        with open(os.path.join("test", "chef_test_Di", "Header")) as hfile:
            hfile.readline()
            hfile.readline()
    ...
    def test_byreaction_field(self):
        ...
        with open(os.path.join("test",
            ...
            for ridx, field in zip([0, 4, 5], fields):
