...
def main():
    ...
    parser.add_argument(
        ...
        action="store_true",
        help=(
            "Validate the binary data against the max/mins in the"
    ...
    parser.add_argument(
        ...
        action="store_true",
        help=(
            "Validate that the boxes coordinates in the plotfile"
    ...
    parser.add_argument(
        "--verbose", "-v", type=int, help="Verbosity level (Defaults to 1)"
    )
